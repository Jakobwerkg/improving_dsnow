...
# ------------------------------------------------------------
# PHASE 5 — Additional variations (exploring corners & bias focus)
# ------------------------------------------------------------
run_phase "Phase 5A — SWE-dominant + small bias   (0.8 / 0.1 / 0.1)" 0.8 0.1 0.1
run_phase "Phase 5B — Density-dominant + small bias (0.1 / 0.8 / 0.1)" 0.1 0.8 0.1
run_phase "Phase 5C — Balanced with moderate bias (0.4 / 0.4 / 0.2)" 0.4 0.4 0.2
run_phase "Phase 5D — Bias-focused                (0.25 / 0.25 / 0.5)" 0.25 0.25 0.5
