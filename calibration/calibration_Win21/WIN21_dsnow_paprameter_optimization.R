# -----------------------------------------------------------------------------
# DELTASNOW PARAMETER OPTIMIZATION (Win21)
# -----------------------------------------------------------------------------
#
...
# Nelder‑Mead optimizer, and output formatting of the second script.
#
# Objective:
...
# ----------------------------------------------------------------------------
# OPTIMIZATION (Nelder-Mead as in second script)
# ----------------------------------------------------------------------------
...
# Print final parameters as Python pydeltasnow call (unscaled)
...
save_file <- paste0("/Users/jakobwerkgarner/code/mt_dsnow/calibration/calibration_Win21/data/R_opt_logs/opt_results_Win21__", weight_tag, ".rds")
